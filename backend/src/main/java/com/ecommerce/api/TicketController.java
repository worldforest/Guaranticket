...
public class TicketController {
	...
	@Autowired
	public TicketController(ITicketService ticketService, IJwtService jwtService) {
	...
	public ModelAndView kakaoPaySuccess(@RequestParam("pid") long pid, @RequestParam("seatNumber") int seatNumber,
			@RequestParam("date") String date, @RequestParam("time") String time, @RequestParam("grade") String grade,
...
//				"redirect:https://j3b101.p.ssafy.io/purchaselist?tid=" + tickets.getTid() + "&uid=" + tickets.getUid());
	...
	public List<Ticket> getByPidAndDateAndTime(@PathVariable long pid, @PathVariable String date,
